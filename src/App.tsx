    ...
    <div className="relative text-white min-h-screen overflow-x-hidden">
      ...
      <section id="top" className="relative w-full h-[60vh] md:h-[70vh] overflow-hidden mb-20">
        ...
        <div className="absolute top-20 left-8 md:left-14 right-8 md:right-14 flex items-start justify-between">
          ...
          >
            <span
              className="text-xl sm:text-4xl md:text-6xl font-bold tracking-tight leading-none [font-family:var(--font-heading)] select-none"
              style={{
      ...
      <section id="work" className="max-w-6xl mx-auto mb-40 px-6 scroll-mt-28">
        ...
        {/* dareit.gg — featured card */}
        <motion.a
          href="https://dareit.gg"
          target="_blank"
          rel="noopener noreferrer"
          {...fadeUp}
          ...
          <div className="relative grid md:grid-cols-[1fr_1.1fr]">
            <div className="p-10 flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-3 [font-family:var(--font-heading)] group-hover:text-[#60A5FA] transition-colors duration-300">dareit.gg</h3>
                <p className="text-zinc-400 leading-relaxed mb-7 max-w-sm">{t.work.dareit.desc}</p>
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <p className="text-zinc-300">{t.work.dareit.problem}</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-zinc-600 uppercase tracking-[0.15em] mb-1 [font-family:var(--font-heading)]">{t.work.solutionLabel}</p>
                    <p className="text-zinc-300">{t.work.dareit.solution}</p>
                  </div>
                </div>
              </div>
              <p className="mt-8 text-[11px] text-zinc-600 font-mono">Next.js · Python · Supabase · Tailwind CSS · Vercel</p>
            </div>

            <div className="relative bg-zinc-900/50 border-l border-zinc-800/50 min-h-[280px] overflow-hidden">
              <img src="/dareit.png" alt="dareit.gg screenshot" className="w-full h-full object-cover object-top" />
            </div>
          </div>
        </motion.a>
          ...
          <div className="px-10 py-16 md:py-20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full px-8 py-3.5 border border-zinc-700 text-zinc-300 font-semibold hover:border-zinc-500 hover:text-white transition-colors duration-200 [font-family:var(--font-heading)]"
              >
                dnwayne97@gmail.com ↗
              </a>
            </div>
